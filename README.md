...
```
Note : if Server Reflection is enabled which provides information about publicly-accessible gRPC services on a server, then
no need to specify the FileDescriptorSet binary.
